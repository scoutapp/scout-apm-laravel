...
final class ScoutViewCompilerEngineDecorator extends CompilerEngine
{
    ...
    public function __construct(CompilerEngine $realEngine, ScoutApmAgent $agent, Factory $viewFactory)
    {
